...
hi NonText guibg=#878787 gui=bold ctermfg=102 ctermbg=233 cterm=bold
hi SignColumn guibg=#e7e7e7 guifg=#000000 gui=bold ctermfg=16 ctermbg=254 cterm=bold
hi StatusLine guibg=fg guifg=#000000 gui=bold ctermfg=16 ctermbg=252 cterm=bold
hi StatusLineNC guibg=#878787 guifg=#000000 gui=bold ctermfg=243 ctermbg=252
...
hi htmlBoldUnderline guibg=bg guifg=fg gui=bold,italic
